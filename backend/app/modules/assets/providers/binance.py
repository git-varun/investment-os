...
class BinanceProvider(PriceProvider):
    ...
    def get_price(self, symbol: str, asset_type: str) -> PricePayload | None:
        ...
        # Reverse the portfolio-sync rename (S → SONIC stored in DB, but Binance trades as S)
        _INTERNAL_TO_BINANCE = {"SONIC": "S", "MATIC": "POL"}
        base = _INTERNAL_TO_BINANCE.get(base, base)
